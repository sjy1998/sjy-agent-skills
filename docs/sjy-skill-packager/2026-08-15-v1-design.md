...
- **Status:** Approved / Frozen for V1 planning
- **Date:** 2026-08-15
...
The Skill orchestrates user intent and result handling. The Python script owns deterministic filesystem, validation, archive, and verification logic. Repository-level tests stay outside the distributable Skill package.
